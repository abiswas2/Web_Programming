...
function validatePersonal(){
  ...
  if( fname === "" || lname === ""){
    errorMsg = "<p> Please enter a valid first and last name. </p>";
  } 
  if (genderValue === "") {
      errorMsg += "<p> Please select a 'Gender' to continue. </p>";
  }
  if (dob === "") {
    errorMsg += "<p> Please select your date of birth. </p>";
  }
...
function initializeGame(){
  ...
  document.getElementById("phoneLink").setAttribute("href", phoneLink);
  document.getElementById("phoneLinkMob").setAttribute("href", phoneLinkMob);
  setQuestion();
  setOptions();
}
